...
function initNavbar() {
  ...
  // Quando o usuário rola mais de 20px para baixo,
  // adicionamos a classe --scrolled que adiciona sombra à navbar.
  ...
  // Ao clicar no botão hambúrguer, togglea a classe --open no menu.
  // O CSS já trata de mostrar/esconder o menu com base nessa classe.
  menuToggle.addEventListener('click', function () {
    const isOpen = navMenu.classList.toggle('navbar__menu--open');

    // Troca o ícone entre "menu" (hambúrguer) e "x" (fechar)
    menuToggle.innerHTML = isOpen
      ? '<i data-lucide="x"></i>'
      : '<i data-lucide="menu"></i>';

    // Reinicializa os ícones para o novo ícone aparecer
    lucide.createIcons();
  ...
  // Em mobile, ao clicar em qualquer link de navegação,
  // o menu se fecha automaticamente (boa experiência do usuário).
  ...
  // Se o usuário clicar em qualquer parte da página fora do menu,
  // o menu se fecha. Isso é comportamento padrão esperado pelo usuário.
